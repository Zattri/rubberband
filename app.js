...
const post = require('./src/poster')
const query = require('./src/queryer')
...
app.get('/query', (req, res) => {
  let searchArray = [
    'Search term' // Something from req.body in here
  ]
...
app.post('/bulkpost', (req, res) => {
  ...
  res.send(post(address, elasticParams, reqMethod, dirPath))
})
